...
public class LightController : BaseController
{
    ...
    [Header("Flash")]
    public float baseIntensity = 0.6f;   // 평소 밝기
    public float peakIntensity = 2.0f;   // 번쩍 피크
    public float rise = 0.05f;           // 켜지는 시간
    public float fall = 0.22f;           // 꺼지는 시간
    public bool ignoreTimeScale = true;  // 일시정지에도 번쩍
